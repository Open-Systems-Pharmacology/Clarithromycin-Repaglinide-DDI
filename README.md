...
Modeling of published clinical clarithromycin-repaglinide-DDI studies for model evaluation

### Repository files
Within this repository, we distribute a PK-Sim project file containing simulations of all published clinical studies used to evaluate the predictive performance of our models regarding the clarithromycin-repaglinide-DDI, including the respective observed data digitized from literature reports. The applied [clarithromycin](https://github.com/Open-Systems-Pharmacology/Clarithromycin-Model) model has been published previously. For further details and documentation please refer to [[1](#reference)].
